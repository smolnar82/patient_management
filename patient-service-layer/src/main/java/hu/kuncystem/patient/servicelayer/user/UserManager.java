...
public interface UserManager {
	 ...
	 * @return It will return new row id for success otherwise it will return null.
	 */
	 ...
	 * @param password This is the user’s password.
	 * @param active This is a flag that the user’s state is enable or disable.
	 * @param fullname This is the user’s full name(surname and firstname).
	 * @param email This is the user’s valid email address.
	 * @return It will return new row id for success otherwise it will return null.
	 */
	 ...
	 *
	 * @param userId This is the unique user id. This id identifies one row in User table. We will update this row.
	 * @param name This is the user’s name.
	 * @param password This is the user’s password.
	 * @param active This is a flag that the user’s state is enable or disable.
	 * @param fullname This is the user’s full name(surname and firstname).
	 ...
	 *
	 * @param userId This is the unique user id. This id identifies one row in User table. We will delete this row.
	 ...
	 *
	 * @param id This is the unique user id. This id identifies one row in User table. 
	 * @return Object.User object is a simple POJO object. This method return null if the user isn’t found in the database.
	 */
