...
public interface UserGroupManager {
	 ...
	 *
	 * @param name This is the name of group.
	 ...
	 *
	 * @param name This is the name of group.
	 * @param note This is a short description of group.
	 * @return It will return new row id for success otherwise it will return null.
	 */
	 ...
	 *
	 * @param id This is the unique group id. This id identifies one row in UserGroup table.
	 * @return Object.UserGroup object is a simple POJO object. This method return null if the group isn’t found in database.
	 */
	 ...
	 *
	 * @param userId This is the unique user id. This id identifies one row in User table.
	 * @param groupId This is the unique group id. This id identifies one row in UserGroup table.
