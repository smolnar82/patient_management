...
public class Session {
	...
	/**
	 * This class will pass information to session dao object to get the data it needs.
	 *
	 */
	public Session() {}
	 ...
	 * This class will pass information to session dao object to get the data it needs.
	 *
	 * @param id Identification of one session.
	 */
	 ...
	 * This class will pass information to session dao object to get the data it needs.
	 *
	 * @param userId This is the unique user id. This id identifies one row in the User table.
	...
	/**
	 * Add user's data from the pc or the web browser. This string have to contains more information which identifies the workstation.
	 *
	 * @param userAgent Data of browser or pc
	 */
	 ...
	 *
	 * @param disabled true: session is enabled, false: session is disabled
	 */
