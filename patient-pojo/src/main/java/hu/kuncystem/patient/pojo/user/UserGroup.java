...
public class UserGroup {
    ...
    /**
     * This class will pass information to user group dao object to get the data
     * it needs.
     *
     */
    public UserGroup() {
     ...
     *
     * @param id
     *            ): This is a unique row id of the user group in database. If
     *            this id is -1 then this object doesn�t contain data of new
     *            user. If the id is greater than -1 then this object contains
     *            data of an existing user.
     */
     ...
     * 
     * @param id
     *            Identification of one user group. If the value is -1 then it
